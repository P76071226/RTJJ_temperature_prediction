...
actual_temps = pd.read_csv('/data/data/com.termux/files/home/hermes_research/rjtt_project/historical_temps_6months.csv', 
                           index_col=0, parse_dates=True)['actual_max_temp']

# Load NEW trained model
model_data = joblib.load('/root/hermes_research/rjtt_project/models/xgboost_calibrated_v2.pkl')
model = model_data['model']
calibrators = model_data['calibrators']
class_to_idx = model_data['class_to_idx']
idx_to_class = model_data['idx_to_class']
unique_classes = model_data['unique_classes']
intervals = model_data['intervals']
interval_labels = model_data['interval_labels']

# Load archive data
archive_dir = Path('/data/data/com.termux/files/home/hermes_research/rjtt_project/archive')
results = []
...
print("="*80)
print("BACKTEST SUMMARY (Retrained Model)")
print("="*80)
...
if len(df_results) > 0:
    ...
    df_results.to_pickle('/data/data/com.termux/files/home/hermes_research/rjtt_project/backtest_v2_results.pkl')
    print("\nResults saved to backtest_v2_results.pkl")